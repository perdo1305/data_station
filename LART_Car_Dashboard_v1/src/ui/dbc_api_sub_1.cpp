...
void init_dbc_api_subscribers_chunk_1(std::shared_ptr<rclcpp::Node> node, std::vector<rclcpp::SubscriptionBase::SharedPtr>& subs) {
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv1Setdriveenable>(
        "/pwt/dbc/inv1_setdriveenable", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv1Setdriveenable> msg) {
            if (msg) {
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv1Seterpm>(
        "/pwt/dbc/inv1_seterpm", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv1Seterpm> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv1Setmaxacbrakecurrent>(
        "/pwt/dbc/inv1_setmaxacbrakecurrent", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv1Setmaxacbrakecurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv1Setmaxaccurrent>(
        "/pwt/dbc/inv1_setmaxaccurrent", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv1Setmaxaccurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv1Setmaxdcbrakecurrent>(
        "/pwt/dbc/inv1_setmaxdcbrakecurrent", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv1Setmaxdcbrakecurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv1Setmaxdccurrent>(
        "/pwt/dbc/inv1_setmaxdccurrent", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv1Setmaxdccurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv1Setposition>(
        "/pwt/dbc/inv1_setposition", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv1Setposition> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv1Setrelbrakecurrent>(
        "/pwt/dbc/inv1_setrelbrakecurrent", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv1Setrelbrakecurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv1Setrelcurrent>(
        "/pwt/dbc/inv1_setrelcurrent", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv1Setrelcurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv1Targetiq>(
        "/pwt/dbc/inv1_targetiq", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv1Targetiq> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv1Temperatures>(
        "/pwt/dbc/inv1_temperatures", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv1Temperatures> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2AcDcCurrent>(
        "/pwt/dbc/inv2_ac_dc_current", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2AcDcCurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2ErpmDutyVoltage>(
        "/pwt/dbc/inv2_erpm_duty_voltage", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2ErpmDutyVoltage> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Foc>(
        "/pwt/dbc/inv2_foc", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Foc> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Minmaxaccurrent>(
        "/pwt/dbc/inv2_minmaxaccurrent", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Minmaxaccurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Minmaxdccurrent>(
        "/pwt/dbc/inv2_minmaxdccurrent", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Minmaxdccurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Misc>(
        "/pwt/dbc/inv2_misc", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Misc> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Setaccurrent>(
        "/pwt/dbc/inv2_setaccurrent", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Setaccurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Setbrakecurrent>(
        "/pwt/dbc/inv2_setbrakecurrent", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Setbrakecurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Setdigoutput>(
        "/pwt/dbc/inv2_setdigoutput", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Setdigoutput> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Setdriveenable>(
        "/pwt/dbc/inv2_setdriveenable", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Setdriveenable> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Seterpm>(
        "/pwt/dbc/inv2_seterpm", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Seterpm> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Setmaxacbrakecurrent>(
        "/pwt/dbc/inv2_setmaxacbrakecurrent", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Setmaxacbrakecurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Setmaxaccurrent>(
        "/pwt/dbc/inv2_setmaxaccurrent", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Setmaxaccurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Setmaxdcbrakecurrent>(
        "/pwt/dbc/inv2_setmaxdcbrakecurrent", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Setmaxdcbrakecurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Setmaxdccurrent>(
        "/pwt/dbc/inv2_setmaxdccurrent", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Setmaxdccurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Setposition>(
        "/pwt/dbc/inv2_setposition", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Setposition> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Setrelbrakecurrent>(
        "/pwt/dbc/inv2_setrelbrakecurrent", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Setrelbrakecurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Setrelcurrent>(
        "/pwt/dbc/inv2_setrelcurrent", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Setrelcurrent> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Inv2Targetiq>(
        "/pwt/dbc/inv2_targetiq", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Inv2Targetiq> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
