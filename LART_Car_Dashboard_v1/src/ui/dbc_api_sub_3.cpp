...
void init_dbc_api_subscribers_chunk_3(std::shared_ptr<rclcpp::Node> node, std::vector<rclcpp::SubscriptionBase::SharedPtr>& subs) {
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave03TemperatureId2>(
        "/pwt/slave_03_temperature_id_2", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave03TemperatureId2> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave03VoltageId1>(
        "/pwt/slave_03_voltage_id_1", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave03VoltageId1> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave03VoltageId2>(
        "/pwt/slave_03_voltage_id_2", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave03VoltageId2> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave03VoltageId3>(
        "/pwt/slave_03_voltage_id_3", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave03VoltageId3> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave04MscId1>(
        "/pwt/slave_04_msc_id_1", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave04MscId1> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave04MscId2>(
        "/pwt/slave_04_msc_id_2", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave04MscId2> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave04TemperatureId1>(
        "/pwt/slave_04_temperature_id_1", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave04TemperatureId1> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave04TemperatureId2>(
        "/pwt/slave_04_temperature_id_2", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave04TemperatureId2> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave04VoltageId1>(
        "/pwt/slave_04_voltage_id_1", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave04VoltageId1> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave04VoltageId2>(
        "/pwt/slave_04_voltage_id_2", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave04VoltageId2> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave04VoltageId3>(
        "/pwt/slave_04_voltage_id_3", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave04VoltageId3> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave05MscId1>(
        "/pwt/slave_05_msc_id_1", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave05MscId1> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave05MscId2>(
        "/pwt/slave_05_msc_id_2", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave05MscId2> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave05TemperatureId1>(
        "/pwt/slave_05_temperature_id_1", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave05TemperatureId1> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave05TemperatureId2>(
        "/pwt/slave_05_temperature_id_2", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave05TemperatureId2> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave05VoltageId1>(
        "/pwt/slave_05_voltage_id_1", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave05VoltageId1> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave05VoltageId2>(
        "/pwt/slave_05_voltage_id_2", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave05VoltageId2> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave05VoltageId3>(
        "/pwt/slave_05_voltage_id_3", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave05VoltageId3> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave06MscId1>(
        "/pwt/slave_06_msc_id_1", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave06MscId1> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave06MscId2>(
        "/pwt/slave_06_msc_id_2", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave06MscId2> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
    ...
    subs.push_back(node->create_subscription<lart_msgs::msg::Slave06TemperatureId1>(
        "/pwt/slave_06_temperature_id_1", sensor_qos, [](const std::shared_ptr<lart_msgs::msg::Slave06TemperatureId1> msg) {
            if (msg) {
                std::lock_guard<std::mutex> lock(dbc_api_mutex);
